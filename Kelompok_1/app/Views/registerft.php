        ...
        <div class="registration-container">
          ...
          <main class="form-container">
            ...
            <form action="register/save" method="post">
              ...
              <input type="text" id="nama" class="form-input" placeholder="Masukkan Nama Lengkap" name="nama"
                required />
              ...
              <input type="text" id="no_hanphone" class="form-input" placeholder="Masukkan No. Handphone"
                name="no_hanphone" required />
              ...
              <input type="text" id="masuk_sebagai" class="form-input" placeholder="Masuk Sebagai" name="masuk_sebagai"
                required />
              <div class="form-group">
              ...
              <input type="password" id="password" class="form-input" placeholder="Masukkan Password" name="password"
                required />
                <?php if (session()->getFlashdata('confpassword')): ?>
                <div class="alert"><?= session()->getFlashdata('confpassword') ?>
                </div> <?php endif; ?>
              <div class="form-group">
                <label for="confpassword" class="form-label">Konfirmasi Password</label>
                <span class="required">*</span>
              </div>
              <input type="password" id="confpassword" class="form-input" placeholder="Masukkan Konfirmasi Password"
            ...
            <div class="signup-section">
              <div class="signup-text">
                <p class="signup-question">Sudah Mempunyai Akun? </p>
                <a href="<?= base_url('login') ?>" class="signup-link">Login</a>
              </div>
            </div>
          </main>
        </div>

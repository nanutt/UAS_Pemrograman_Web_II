            ...
            <div class="content">
                ...
                <div class="table-header-pengajuan">
                    ...
                    <button class="add-button">
                        <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/2a8ed5e5247929b7fa919f1983a2481e7c413ab8b30da300f0cbe2506f3ca545?apiKey=e72ded3b641e48ceb0e36e65e1fc6345&" alt="Add Icon" class="menu-icon">
                    ...
                    <?php $nomor = 1; ?>
                        ...
                        <?php foreach ($pengajuan as $row) : ?>
                            ...
                            <td><?php echo $nomor++; ?></td>
                                ...
                                <td><section class="approval-container">
                                        <p class="approval-status">Disetujui</p>
                                      </section></td>
                                <td>
                                <nav class="action-bar">
                                    <button class="action-button action-button-detail">
                                      <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/be3c7dad9e7898184e35146d72d1889895012cfdbf6b7abe40318e40611756cd?apiKey=e72ded3b641e48ceb0e36e65e1fc6345&" alt="" class="action-icon" />
                                      <span class="visually-hidden">Detail</span>
                                      Detail
                                    </button>    
                                    <button class="action-button action-button-download">
                                      <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/a59370360c112a7937c1020394bb41ac75d5618569e957d7e505f154fd333045?apiKey=e72ded3b641e48ceb0e36e65e1fc6345&" alt="" class="action-icon" />
                                      <span class="visually-hidden">Tanggapan</span>
                                      Unduh
                                    </button>
                                  </nav>
                                </td>
